...
> `chain_id, sender, recipient, amount, fee, nonce`. The signature and public key
...
> Five cases move every field and sit on the numeric edges (`u128::MAX` amount
> and fee, `u64::MAX` nonce) where a mis-typed integer width surfaces.
